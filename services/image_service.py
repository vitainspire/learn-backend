...
# Google API key used for direct image generation (Gemini/Imagen) — separate from OpenRouter
_API_KEY   = os.environ.get("GOOGLE_API_KEY", os.environ.get("GEMINI_API_KEY", ""))
