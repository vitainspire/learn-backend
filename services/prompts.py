            ...
            "questions": [
                {
                    ...
                    "image_url": "string | null — copy verbatim from the textbook_exercises entry if it has an image_url; omit otherwise",
                    "diagram": {
...
"""
    ...
    if ontology_context and "textbook_exercises" in ontology_context:
        textbook_reminder = (
            ...
            'Elaborate tasks. Quote the exact exercise text as written. '
            'Do NOT include exercise codes or IDs (e.g. E_2_3_1) in the output — only the exercise content. '
            'If a textbook exercise has an "image_url" field, copy it verbatim to the worksheet question\'s "image_url" field. '
